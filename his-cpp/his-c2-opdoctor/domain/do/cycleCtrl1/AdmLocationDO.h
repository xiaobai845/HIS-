#pragma once
#ifndef _ADMLOCATIONDO_H_
#define _ADMLOCATIONDO_H_
#include "../DoInclude.h"

class AdmLocationDO : public BaseDO
{
public:
...
public:
    AdmLocationDO() : BaseDO("adm_location")
    {
...
typedef std::shared_ptr<AdmLocationDO> PtrAdmLocationDO;
#endif