...
props[PropertyKeyConst::AUTH_USERNAME] = m_username; \
props[PropertyKeyConst::AUTH_PASSWORD] = m_password; \
...
NacosClient::NacosClient(const string& address, const string& namespaceId, const string& username /*= "nacos"*/, const string& password /*= "nacos"*/)
{
	...
	this->instanceId = std::to_string(SnowFlake::getInstance(0, 0)->nextId());
#endif
}
