...
/**
 * 定义一个SQL填充参数数据集添加数据宏
 * @param __PARAMS__: 存储参数数据集对象
 * @param __PARAM_KEY__: 数量类型占位符，如："i"、"s"、"d"、"b"、"dt"、"nul"、"ull"、"ll"、"ui"
 * @param __VAL_TYPE__: 数据类型，如：int32_t、uint32_t、int64_t、uint64_t、std::string、double、bool
 * @param __VAL_VAL__: 参数值
 */
...
public:
	...
	// Parameter: const string& sql sql语句
	// Parameter: const char* fmt 可变参数格式字符串,如:%s%i%b%d%dt%n
	// Parameter: ... 可变参数
	//************************************
