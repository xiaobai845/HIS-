#pragma once
#ifndef _ADMENCOUNTERLOCATIONDO_H_
#define _ADMENCOUNTERLOCATIONDO_H_
#include "../DoInclude.h"

class AdmEncounterLocationDO : public BaseDO
{
public:
    ...
    //ø∆ “ID
    MYSQL_SYNTHESIZE(string, location_id, LocationId);
...
typedef std::shared_ptr<AdmEncounterLocationDO> PtrAdmEncounterLocationDO;
#endif