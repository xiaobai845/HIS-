...
- `zo_his.sql`：包含建库、建表语句，<b style="color:red">必须执行</b>
- `zo_his_init*.sql`：定义系统初始化必须要创建的数据，<b style="color:red">必须执行</b>
- `zo_his_idx.sql`：定义表索引约束，<b style="color:blue">可选执行</b>
- `zo_his_test*.sql`：定义开发测试数据，<b style="color:blue">可选执行</b>
