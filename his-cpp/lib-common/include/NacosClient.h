...
public:
	...
	// Parameter: const string& username 用户名,默认值：nacos
	// Parameter: const string& password 密码,默认值：nacos
	//************************************
	NacosClient(const string& address, const string& namespaceId, const string& username = "nacos", const string& password = "nacos");
