#pragma once
#ifndef _ADMORGANIZATIONDO_H_
#define _ADMORGANIZATIONDO_H_
#include "../DoInclude.h"

class AdmOrganizationDO : public BaseDO
{
public:
    MYSQL_SYNTHESIZE(string, id, Id);
    MYSQL_SYNTHESIZE(string, tenant_id, TenantId);
    MYSQL_SYNTHESIZE(string, name, Name);
    MYSQL_SYNTHESIZE(string, parent_id, ParentId);
...
typedef std::shared_ptr<AdmOrganizationDO> PtrAdmOrganizationDO;
#endif