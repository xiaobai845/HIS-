...
#include <bsoncxx/types/id-fwd.hpp> // IWYU pragma: export
#include <bsoncxx/types/value-fwd.hpp> // IWYU pragma: export
#include <bsoncxx/types/view-fwd.hpp> // IWYU pragma: export
